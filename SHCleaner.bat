@echo off
title SHCleaner v3.0.2 By SarahH12099
...
:: AirParrot 3
if exist "%localappdata%\AirParrot 3" (
taskkill /F /IM "AirParrot3.exe">nul 2>&1
del /q /f "%localappdata%\AirParrot 3\*.log">nul 2>&1
)>nul 2>&1
